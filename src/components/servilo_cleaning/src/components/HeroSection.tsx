        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <motion.button
              ...
              className="gap-3 bg-gradient-to-r from-[#F9F37A] via-[#D2A95E] to-[#F9F37A] text-black border-none hover:opacity-90 px-6 py-3 rounded-xl font-semibold text-lg flex items-center justify-center"
            >
