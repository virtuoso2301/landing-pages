...
const SecondPage = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-[#0F172A] py-0 sm:py-20"
    >
      <motion.section
      ...
      >
        <div className="container mx-auto px-2 sm:px-4 mt-0 sm:mt-8 mb-0 sm:mb-8">
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 md:gap-12 lg:gap-24">
            ...
            >
              <div
                className={`bg-gradient-to-b from-[#000000]/70 to-[#000000]/70 ${featureSecondaryDimensions.roundedClass} p-[6px] shadow-lg flex flex-col items-center justify-center relative`}
                style={{ width: featureSecondaryDimensions.width, height: featureSecondaryDimensions.height }}
              >
                {/* Mobile Frame Design */}
                <div
                  className={`absolute top-0 left-1/2 transform -translate-x-1/2 bg-gradient-to-b from-[#000000]/70 to-[#000000]/70 rounded-b-xl z-10`}
            ...
            >
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className={`bg-gradient-to-b from-[#000000] to-[#000000] ${featureMainDimensions.roundedClass} p-2 shadow-2xl flex flex-col items-center justify-center relative`}
                ...
                {featureImages.map((_, idx) => (
                  <button
                    ...
                    className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full border-2 transition-all duration-200 ${
                      currentFeatureImage === idx ? "bg-[#8b2a8b] border-[#8b2a8b]" : "bg-transparent border-[#8b2a8b] hover:bg-[#e63366]"
                    }`}
